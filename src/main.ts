...
class MitsubishiSmartMAirAdapter extends utils.Adapter {
  ...
  private async onReady(): Promise<void> {
    ...
    const persistedNative = (instanceObject?.native ?? {}) as Partial<AdapterNativeConfig>;
    const nativeConfig = {
      ...(this.config as AdapterNativeConfig),
      ...persistedNative
    } as AdapterNativeConfig;
  ...
  private parseDiscoverySubnets(value: AdapterNativeConfig["discoverySubnets"]): string[] {
    if (Array.isArray(value)) {
